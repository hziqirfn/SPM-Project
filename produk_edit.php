...
size="10" required></p>
<p>DETAIL PRODUK<br>
<textarea name="detail" rows="10" cols="50" required><?php echo $qProduk['detail'];?></textarea></p>
<p>GAMBAR<br>
<img src="gambar/<?php echo $qProduk['gambar']; ?>"width="30%" height="auto">
<input type="text" name="id" value="<?php echo $qProduk['idProduk'];?>" hidden>
<br>
<br><button name="submit" type="submit">SIMPAN</button><br>
